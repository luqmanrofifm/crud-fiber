...
func (service *BookService) CreateBook(dto request.CreateBookDto, user *entity.User) (*entity.Book, error) {
	book := entity.Book{
...
func (service *BookService) UpdateBook(id uuid.UUID, dto request.UpdateBookDto, user *entity.User) (*entity.Book, error) {
	book, err := service.BookRepository.FindByID(id)
	if err != nil {
		return nil, err
	}
